# 🦊CodeFox - AI-Powered Pull Request Reviewer
...
# 🦊CodeFox - AI-Powered Pull Request Reviewer. Stop shipping slop. Start shipping quality.
...
CodeFox `ai-pr-reviewer` is an AI-based code reviewer and summarizer for
...
- [Overview](#overview)
- [Professional Version of CodeFox](#professional-version-of-codefox)
- [Reviewer Features](#reviewer-features)
- [Install instructions](#install-instructions)
- [Conversation with CodeFox](#conversation-with-codefox)
- [Examples](#examples)
...
jobs:
  review:
    ...
    steps:
      - uses: codefox/ai-pr-reviewer@latest
        env:
...
```yaml
system_message: |
  You are `@codefox` (aka `github-actions[bot]`), a language model
  trained by OpenAI. Your purpose is to act as a highly experienced
  DevRel (developer relations) professional with focus on cloud-native
  infrastructure.

  Company context -
  CodeFox is an AI-powered Code reviewer.It boosts code quality and cuts manual effort. Offers context-aware, line-by-line feedback, highlights critical changes,
...
## Conversation with CodeFox

You can reply to a review comment made by this action and get a response based
on the diff context. Additionally, you can invite the bot to a conversation by
tagging it in the comment (`@codefox`).

Example:

> @codefox Please generate a test plan for this file.
